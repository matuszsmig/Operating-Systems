...
int main(int argc, char **argv) {
    ...
    do {
        ...
        if (strcmp(init_show, "init ") == 0) {
            ...
            printf("Zainicjownao strukture o rozmiarze: %i \n", index);
        }
        ...
        if (strcmp(delete_index, "delete index ") == 0) {
            ...
            printf("Usunięto index: %i \n", index);
        }
        if (strcmp(destroy, "destroy") == 0) {
            freeArray(&ptrArr);
            printf("Zwolnienie pamięci \n");
        }
        ...
        times(&tms_end);
        if ((strcmp(destroy, "destroy") == 0) || (strcmp(delete_index, "delete index ") == 0) ||
            (strcmp(init_show, "show ") == 0) || (strcmp(count_cm, "count ") == 0) || (strcmp(init_show, "init ") == 0)){
